  ...
  return (
    <nav className="flex flex-wrap items-center justify-between p-6 border-b-2 border-gray-200 text-black mb-10">
      <div className="flex items-center flex-shrink-0 mr-8 text-black">
        <Link to="/">
          <StaticImage alt="Strybosch Films" src="../images/logo.png" className="block w-32 sm:w-48 md:w-64" placeholder="white" objectFit="contain" loading="eager"></StaticImage>
        </Link>
      </div>
